...
import com.cr.house.repository.HouseDetailRepository;
import com.cr.house.repository.HouseRepository;
import com.cr.house.repository.HouseTagRepository;
...
public class SearchServiceImpl implements ISearchService{
    ...
    private void handleMessage(String content) {//消息结构体
        try {
...
//	        );
//       boolQuery.must(
//               QueryBuilders.matchQuery(HouseIndexKey.DISTRICT, rentSearch.getKeywords())
//                        .boost(2.0f)
//        );
        boolQuery.must(
        ...
        SearchRequestBuilder requestBuilder = this.esClient.prepareSearch(INDEX_NAME)
                ...
                .setFetchSource(HouseIndexKey.HOUSE_ID, null);//只返回一个house_id
    ...
    public ServiceResult<Long> aggregateDistrictHouse(String cityEnName, String regionEnName, String district) {
        ...
        SearchRequestBuilder requestBuilder = this.esClient.prepareSearch(INDEX_NAME)
                ...
                .addAggregation(
                        AggregationBuilders.terms(HouseIndexKey.AGG_DISTRICT)
                                .field(HouseIndexKey.DISTRICT)//对小区字段索引
                ).setSize(0);
        ...
        SearchResponse response = requestBuilder.get();
        if (response.status() == RestStatus.OK) {
            Terms terms = response.getAggregations().get(HouseIndexKey.AGG_DISTRICT);//获取到聚合小区的名字
    ...
    private void createOrUpdateIndex(HouseIndexMessage message) {
        ...
        boolean success;
        long totalHit = searchResponse.getHits().getTotalHits();//接受到查询的数据
        if (totalHit == 0) {
